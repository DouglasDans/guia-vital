    ...
    <Fragment>
      ...
      <Container>
        <div style={{border: '1px solid rgba(0, 0, 0, 0.15)', padding: '2rem 1rem', borderRadius: '4px'}}>
          ...
          <Link to={'/registrosintomas'} style={{background: '#C7F5FF', fontWeight: '600', padding: '0.5rem 2rem', textDecoration: 'none', color: 'black', borderRadius: '4px'}}>Registrar Sintomas</Link>
        </div>
      </Container>
