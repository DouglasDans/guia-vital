...
export default function Chat() {
  return (
    <Fragment>
      ...
      <Container>
        <div>
          <div style={{position: 'absolute', bottom: '80px', width: '100vw', display: 'flex', justifyContent: 'flex-end'}}>
            <span style={{background: '#F3F3F3', padding: '1rem', borderRadius: '4px'}}>
              Olá Doutor
            </span>
          </div>
          <div style={{position: 'absolute', bottom: '0px', width: '99%', lineHeight: '30px', display: 'flex', justifyContent: 'space-between', padding: '1rem', gap: '1rem'}}>
